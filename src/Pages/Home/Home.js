                ...
                </div>
                {
                    !validUser?.userName && <div className="button-group-wrapper flex md:gap-72 pt-20 flex-col sm:flex-row">
                        <div className="button-wrapper pt-10">
                            <div onClick={() => { toSignUp() }} className="lg:text-xl sm:text-lg btn bg-transparent px-16 text-white  hover:bg-cyan-800 hover:scale-110 hover:tracking-[4px] hover:bg-transparent hover:border-white transition-all w-72 h-16">Sign up</div>
                        </div>
                        <div className="button-wrapper pt-10">
                            <div onClick={() => { toSignIn() }} className="lg:text-xl sm:text-lg btn bg-transparent px-16 text-white hover:bg-cyan-800 hover:scale-110 hover:tracking-[4px] hover:bg-transparent hover:border-white transition-all w-72 h-16">Login</div>
                        </div>
                    </div>
                }
