...
const Footer = () => {
    ...
    const callback = (mutationList, observer) => {
        ...
        else if (string.includes(window.location.pathname)) {
            setFooter(false)
        }
        else {
            setFooter(true)
        ...
        <div>
            <div className='w-100  bg-gray-100 footer-body'>
                <footer className="new_footer_area bg_color">
                    {
                        footer && <div className="new_footer_top pt-0:important">
                    ...
                    <div className='flex'>
                        {
                            !footer && <span className='min-w-[18rem]'></span>
                        }
                        <div className="footer_bottom bg-indigo-100 w-full">
